...
import com.example.vix_schoters_annisaalqorina.databinding.ActivityMainBinding
import com.example.vix_schoters_annisaalqorina.fragment.CategoriesFragment
import com.example.vix_schoters_annisaalqorina.fragment.FavouriteFragment
import com.example.vix_schoters_annisaalqorina.fragment.NewsFragment
import com.example.vix_schoters_annisaalqorina.fragment.ProfileFragment
import com.example.vix_schoters_annisaalqorina.repository.NewsRepository
import com.example.vix_schoters_annisaalqorina.viewmodel.ViewModelFactoryNews
...
class MainActivity : AppCompatActivity(), Serializable, TabLayout.OnTabSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModelProvider = ViewModelFactoryNews(newsRepository)
        viewModelNews = ViewModelProvider(this, viewModelProvider)[ViewModelNews::class.java]
